...
Config.instname = "Universidad Autónoma de Madrid"
Config.profilename = "UAM"
Config.url = "http://www.uam.es/wifi"
Config.email = "cau@uam.es"
Config.title = "eduroam CAT"
Config.server_match = "radius.uam.es"
...
Config.user_realm = "uam.es"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.uam.es']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@uam.es"
Config.tou = ""
