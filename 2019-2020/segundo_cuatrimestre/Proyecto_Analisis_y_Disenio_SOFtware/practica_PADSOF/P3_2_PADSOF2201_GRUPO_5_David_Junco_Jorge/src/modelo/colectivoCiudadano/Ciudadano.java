...
public class Ciudadano extends Usuario implements ElementoColectivo {
    ...
    private String nif;
    private Set<Colectivo> colPertenece;
    private Set<Colectivo> colectRepresentados;
	...
	this.nif = nif;
	colPertenece = new HashSet<>();
	colectRepresentados = new HashSet<>();
     ...
     * Además, si el colectivo es nuevo y este es el representante, lo añade a la
     * colección de colectivos representados
     * 
	...
	colectRepresentados.forEach(col -> col.getProyPropuestos().forEach(res::add));
     ...
     */
    public Set<Colectivo> getColectRepresentados() {
	return this.colectRepresentados;
    }
	...
	sb.append("\nPertenece a:\n");
	colPertenece.forEach(e -> sb.append("\t" + e.getName() + "\n"));
