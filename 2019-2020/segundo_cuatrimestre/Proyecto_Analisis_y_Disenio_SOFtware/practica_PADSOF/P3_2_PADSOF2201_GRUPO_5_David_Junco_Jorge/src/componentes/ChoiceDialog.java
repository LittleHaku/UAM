...
/**
 * El ChoiceDialog representa un diálogo un icono
 * <p>
 ...
 * @version 26-04-20
 */
public class ChoiceDialog extends JDialog implements ComponentListener {
    ...
    protected final MButton ok;
    public static boolean pressed_ok;
     ...
     */
    public ChoiceDialog(JFrame owner, String tit, String desc, String icon) {
	super(owner);
	this.owner = owner;
     ...
     *              botón
     */
    public ChoiceDialog(JFrame owner, String title, String desc, String icon, Consumer<ActionEvent> f) {
	this(owner, title, desc, icon);
	ret.addActionListener(e -> f.accept(e));
	ok.addActionListener(e -> f.accept(e));
    }
     ...
     * <p>
     * Los dialogos de error son instancias de <code> ChoiceDialog </code> que
     * utilizan <br>
	...
	ChoiceDialog id = new ChoiceDialog(owner, title, desc, ComponentConstants.I_ERROR);
	id.setVisible(true);
    }
     ...
     * <p>
     * Los dialogos de éxito son instancias de <code> ChoiceDialog </code> que
     * utilizan <br>
	...
	ChoiceDialog id = new ChoiceDialog(owner, title, desc, ComponentConstants.I_SUCCESS);
	id.setVisible(true);
    }
