 ...
 * Grupo: 2201
 * Fecha: 28-03-2020
 * Descripcion: Ejercicio de multiples procesos utilizando una estructura compartida, con semaforo
 * */
...
#define SHM_NAME "/shm_eje3_solved"
#define MAX_MSG 2000
