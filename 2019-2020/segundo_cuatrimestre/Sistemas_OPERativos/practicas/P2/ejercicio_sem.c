/**
 * @file ejercicio_sem.c
 * @author Junco de las Heras junco.heras@estudiante.uam.es Marta Vaquerizo marta.vaquerizo@estudiante.uam.es
 * Grupo: 2201
 * Fecha: 11-03-2020
 * Descripcion: Test para conocer como funcionan los semaforos.
 * WARNING: VALGRIND DA UN ERROR DE VARIABLE SIN INICIALIZAR EN SEM_OPEN, PERO ESO PARECE QUE ES UN BUG DE VALGRIND
 * */
