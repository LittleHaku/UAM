 ...
 * Grupo: 2201
 * Fecha: 25-04-2020
 * Descripcion: Declaracion de funciones a implementar en sort.c, constantes y datos enumerados para utilizar.
 * */
#ifndef _SORT_H
#define _SORT_H
...
/**
 * Solves a sorting problem using various process.
 * @method sort_multy_process
 * @date   2020-04-24
