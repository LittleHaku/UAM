...
import strategy.AsLongAsPossible;

/**
 * Es el Test del apartado 4, debe producir la salida esperada
 * 
...
public class TesterApartado4 {
	public static void main(String[] args) {
		...
		Node<Integer> n1 = new Node<Integer>(INIT_CONSTANT);// inicializamos el resto a un valor alto, que iremos
															// reduciendo
