/****************************************************
Nombre del módulo: p4_e2.c
Descripción: main que testea el tree.c y escribe el orden pre, in post del arbol
