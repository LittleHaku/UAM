...
/* Devuelve el id del nodo antecesor, o NULL en caso de error */
...
/* Modifica el antecesor de un nodo dado, devuelve NULL en caso de error */
...
/*Devuelve -2 si ha habido error, -1 si n1<n2 c 0 si n1==n2 o 1 en otro caso*/
