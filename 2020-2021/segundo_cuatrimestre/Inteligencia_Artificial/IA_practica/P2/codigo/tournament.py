...
class Tournament(object):
    ...
    def run(self, student_strategies: dict, increasing_depth: bool = True, n_pairs: int = 1,
                            ...
                            if increasing_depth:
                                for depth in range(1, self.__max_depth):
                                    ...
                                    pl2 = Player(
                                        name=name2,
                                        strategy=MinimaxAlphaBetaStrategy(
                                            heuristic=Heuristic(name=sh2.get_name(),
    ...
    def __single_run(self, player1_first: bool, pl1: Player, name1: str, pl2: Player, name2: str, scores: dict,
                     totals: dict):
        players = []
        if player1_first:
            players = [pl1, pl2]
