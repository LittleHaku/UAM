...
*				-  no return value
******************************************************************************/
void pintaListaPixeles(unsigned int numPixeles, unsigned char bgcolor, 
						long int tiempoEspera, int* pixelList_x, int* pixelList_y,
						unsigned char* pixelList_color); 
