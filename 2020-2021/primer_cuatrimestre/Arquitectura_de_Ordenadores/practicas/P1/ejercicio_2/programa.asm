...
salto:
  ...
  # Instrucciones aniadidas:
  addi $t3, $t3, 12  # addi $r11, $r11, 12 (4 + 12) => 16
  addi $t4, $t4, 5   # addi $r12, $r12, 5 (9 + 5) => 14
  slti $t5, $t5, 17  # slti $r13, $r13, (16 < 17) => 1
  j final            # Salta la instruccion addi.
  nop                # Bubble...
  nop                # Bubble...
  nop                # Bubble...
  addi $t6, $t5, 4   # addi $r14, $r13, 4 => NO debe ejecutarse
final:
